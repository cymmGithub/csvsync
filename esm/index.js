import { ParseOptions, StringifyOptions } from './index.d.ts';
/**
 * Converts a JavaScript object/array into a CSV string.
 * @param {any[][] | Record<string, any>[]} data - The data to convert, typically an array of arrays or array of objects.
 * @param {StringifyOptions} [opts] - Options for customizing the CSV output.
...
/**
 * Converts a CSV string into a JavaScript object/array.
 * @param {string | Buffer} csv - The CSV string to parse.
 * @param {ParseOptions} [opts] - Options for customizing the parsing.
 * @returns {any[] | Record<string, any>[]} Parsed data as an array of arrays or array of objects.
 */
export function parse(csv, opts) {
	opts = opts || {};
	const delimiter = opts.delimiter || ',';
